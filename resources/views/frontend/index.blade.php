        ...
        <div class="hero-slide hero-mask" data-bg-src="{{asset('frontend/assets/img/banner/hero2-bg.jpg')}}">
          <div class="container">
            <div class="row align-items-center justify-content-between">
              ...
              <div class="col-lg-6">
                <div class="hero-form2" data-bg-src="{{asset('frontend/assets/img/banner/map-bg.png')}}">
                  <div class="shape-mockup">
                    <img src="{{asset('frontend/assets/img/banner/hero-object.png')}}" alt="hero image">
                  </div>
                  <div>
...
==============================-->
  ...
  ==============================-->
  <section class="space bg-light shape-mockup-wrap" data-bg-src="{{asset('frontend/assets/img/shape/Bg.png')}}">
    ...
    <div class="shape-mockup d-none d-xl-block ripple-animation z-index-negative" data-top="10%" data-left="10%">
      <img src="{{asset('frontend/assets/img/shape/Plane.png')}}" alt="plane">
    </div>
    <div class="container ">
      ...
      <div class="row vs-carousel" data-slide-show="4" data-arrows="false" data-lg-slide-show="3" data-md-slide-show="2"
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{asset('frontend/assets/img/tours/tour-1-1.jpg')}}" alt="Package Image"></a>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6">
          <div class="package-style1">
            <div class="package-img">
              <a href="tour-booking.html"><img class="w-100" src="{{asset('frontend/assets/img/tours/tour-1-2.jpg')}}" alt="Package Image"></a>
            </div>
            <div class="package-content">
