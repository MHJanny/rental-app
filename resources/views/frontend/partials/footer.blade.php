            ...
            <div class="row g-5 justify-content-between">
                    ...
                    <div class="widget footer-widget">
                        <div class="vs-widget-about">
                            <div class="footer-logo">
                                <a href="index.html"><img src="{{ asset('assets/img/white-logo.svg') }}" alt="Travolo"
                                        class="logo" /></a>
                            </div>
                            <p class="footer-text">Curabitur aliquet quam id dui bandit posuere blandit. Vivamfdsus
                                magna justo
                                blandit aliquet.</p>
                ...
                <div class="col-md-6 col-xl-2">
                    <div class="widget widget_nav_menu footer-widget footer-contact">
                        ...
                        <div class="menu-all-pages-container">
                            <ul class="menu">
                                <li><a href="#"><i class="fas fa-map-marker-alt"></i> Fifth Avenue 5501, Broadway, New
                                        York Morris
                                        Street.</a></li>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="widget footer-widget">
                        ...
                        <div class="sidebar-gallery">
                            <a href="{{asset('assets/img/footer/insta1.jpg')}}" class="popup-image"><img
                                    src="{{ asset('assets/img/footer/insta1.jpg') }}" alt="Gallery Image"
                                    class="w-100" />
                            </a>
                            <a href="{{asset('assets/img/footer/insta2.jpg')}}" class="popup-image"><img
                                    src="{{ asset('assets/img/footer/insta2.jpg') }}" alt="Gallery Image"
                                    class="w-100" />
                            </a>
                            <a href="{{asset('assets/img/footer/insta3.jpg')}}" class="popup-image"><img
                                    src="{{ asset('assets/img/footer/insta3.jpg') }}" alt="Gallery Image"
                                    class="w-100" />
                            </a>
                            <a href="{{asset('assets/img/footer/insta4.jpg')}}" class="popup-image"><img
                                    src="{{ asset('assets/img/footer/insta4.jpg') }}" alt="Gallery Image"
                                    class="w-100" />
                            </a>
                            <a href="{{asset('assets/img/footer/insta5.jpg')}}" class="popup-image"><img
                                    src="{{ asset('assets/img/footer/insta5.jpg') }}" alt="Gallery Image"
                                    class="w-100" />
                            </a>
                            <a href="{{asset('assets/img/footer/insta6.jpg')}}" class="popup-image"><img
                                    src="{{ asset('assets/img/footer/insta6.jpg') }}" alt="Gallery Image"
                                    class="w-100" />
                            </a>
                        </div>
                    </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-auto">
                    <p class="copyright-text">Copyright <i class="fal fa-copyright"></i>
                        ...
                        </script> <a href="index.html">Travolo</a>.
